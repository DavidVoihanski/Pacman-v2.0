 ...
 * 1. Create a "play" with one of the 9 attached files 2. Set your ID's - of all
 * the group members (numbers only); 3. Get the GPS coordinates of the "arena" -
 * as in Ex3. 4. Get the game-board data 5. Set the "player" init location -
 * should be a valid location 6. Start the Server 7. while (the game is
 * running): 7.1 "Play" as long as there are "fruits" and time 7.2 get the
 * current score of the game 7.3 get the game-board current state 7.4 goto 7 8.
 * stop the server (this is not needed - in your implementation);
 * 
 * @author ben-moshe
 *
 */
public class Check_if_works {
