...
public abstract class GuiFactory {
	...
	private static double mapH=422.6079031174025;
	private static double mapW=945.2295422334731;
	private static Point3D topLeftP=new Point3D(32.10574,35.20228,0.0);
	...
	public static Point3D gps2Pixel(LatLonAlt gps,double dynHeight,double dynWidth) {
		Point3D vector = converter.vector3D(topLeftP, gps); // creating a meter vector between the top left Gps coord to the
													// chosen point)
